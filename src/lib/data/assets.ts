...
const Assets = {
	...
	UNITTEST: a('unit_test.svg'),
	SQL_ORM: a('sql_alchemy.png'),
	DJANGO_ORM: a('django_orm.png'),
	PROBLEM_SOLVING: a('problem_solving.svg'),
	COMMUNICATION: a('communication.svg'),
	BAHRIA_UNIVERSITY: a('bahria_university.jpeg'),
	PUNJAB_COLLEGE: a('punjab_college.png'),
	BAHRIA_COLLEGE: a('bahria_college.jpeg'),
	DRF: a('drf.png'),
	JWT: a('jwt.png')
